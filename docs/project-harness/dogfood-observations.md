...
| `DF-20260818-002` | MCP 分组成员接口返回完整重对象                    | `fixed_pending_verification`  | `p1`   | 产品缺陷 | performance               |
| `DF-20260818-003` | 许可证字段不能区分开源、source-available 与未识别 | `fixed_pending_verification`     | `p2`   | 能力缺口 | wrong data / confusing UX |
