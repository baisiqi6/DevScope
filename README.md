...
- 仓库健康度、竞争格局和趋势分析
- OSS Insight 数据检索
- DeepSeek / OpenAI-compatible / Anthropic 多提供商 AI 调用
- BGE-M3 向量嵌入与语义搜索
- Agent 流式分析、报告页面与实验性工作流
- `repo-fetch`、`repo-analyze`、`report-generate` 三个 CLI Skills

Langtum/Langcore 工作流、调度器和部分报告链路仍属于实验能力，不应视为稳定的公开 API。
...
| AI   | OpenAI-compatible、DeepSeek、Anthropic、BGE-M3 |
